...
public class MainActivity extends AppCompatActivity implements EmailAdapter.EmailItemClicked {
    ...
    private List<EmailItem> generateData() {
        ...
        list.add(new EmailItem("http://www.stickpng.com/assets/images/5847f9cbcef1014c0b5e48c8.png", "Google", "Do you want to watch your usage statics?", "Do you want to watch your usage statics? We was collected your usage statics for last month.", "Dec 23"));
        ...
        list.add(new EmailItem("http://logok.org/wp-content/uploads/2014/10/Expedia-logo-340x214.png", "Travel company", "You was won the travel to Spain.", "You was won the travel to Spain. Tell us about details", "Feb 7"));
        list.add(new EmailItem("http://www.stickpng.com/assets/images/580b57fcd9996e24bc43c468.png", "Car", "Update your auto system!", "Update your auto system! We was published new auto version 2.6.4!", "Oct 17"));
        return list;
    }
